...
<div class="col-sm-8">
    <div class="title-action">
        <a href="{{ route('admin.nourriture-ingredient.create') . (Request::input("nourriture_id") != '' ? '?nourriture_id='.Request::input("nourriture_id") : '')}}" type="button" class="btn btn-primary">
